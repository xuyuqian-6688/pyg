...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/home/css/pages-JD-index.css" />

    <script type="text/javascript" src="/home/js/all.js"></script>
    <script type="text/javascript" src="/home/js/pages/index.js"></script>
</head>
            ...
            <div class="py-container">
                <div class="shortcut">
                    <ul class="fl">
                        ...
                        @if(session("userInfo.username"))<li class="f-item">{{session("userInfo.username")}}&nbsp;<a href="{{"/logout"}}" target="_blank">退出登录</a></li>
                        @endif
                            @if(!session("userInfo.username"))<li class="f-item">请<a href="{{"/login"}}" target="_blank">登录</a>　<span><a href="{{"/register"}}" target="_blank">免费注册</a></span></li>
                            @endif
    ...
    <div class="py-container">
        <ul class="yui3-g Recommend">
            <li class="yui3-u-1-6  clock">
                <div class="time">
                    <img src="/home/img/clock.png" />
                    <h3>今日推荐</h3>
                </div>
            </li>
            <li class="yui3-u-5-24">
                <a href="list.html" target="_blank"><img src="/home/img/today01.png" /></a>
            </li>
            <li class="yui3-u-5-24">
                <img src="/home/img/today02.png" />
            </li>
            <li class="yui3-u-5-24">
                <img src="/home/img/today03.png" />
            </li>
            <li class="yui3-u-5-24">
                <img src="/home/img/today04.png" />
            </li>
        </ul>
    </div>
</div>
    ...
    <div class="content">
        <ul>
            <li style="display:block;">
                <div class="img-item">
                    <p class="tab-pic">
                        <span><a href="#"><img src="/home/img/1.jpg"/></a></span>
                    </p>
                    <div class="tab-info">
            ...
            <li>
                <div class="img-item">
                    <p class="tab-pic">
                        <span><a href="#"><img src="/home/img/2.jpg"/></a></span>
                    </p>
                    <div class="tab-info">
                        <div class="info-title">
                            <span><a href="#">【官网价直降1100】Apple iPhone 8 Plus 256GB 银色 移动联通电信4G手机</a></span>
            ...
            <ul class="clearfix yui3-g Favourate picLB" id="picLBxxl">
                <li class="yui3-u-1-6">
                    <dl class="picDl huozhe">
                        <dd>
                            <a href="" class="pic"><img src="/home/img/like_02.png" alt="" /></a>
                            <div class="like-text">
                        ...
                        <dd>
                            <a href="" class="pic"><img src="/home/img/like_01.png" alt="" /></a>
                            <div class="like-text">
                ...
                <li class="yui3-u-1-6">
                    <dl class="picDl jilu">
                        <dd>
                            <a href="" class="pic"><img src="/home/img/like_03.png" alt="" /></a>
                            <div class="like-text">
                                <p>爱仕达 30CM炒锅不粘锅NWG8330E电磁炉炒</p>
                                <h3>¥116.00</h3>
                            </div>
                ...
                <li class="yui3-u-1-6">
                    <dl class="picDl jilu">
                        <dd>
                            <a href="http://sc.chinaz.com/" class="pic"><img src="/home/img/like_03.png" alt="" /></a>
                            <div class="like-text">
                                <p>捷波朗 </p>
                                <p>（jabra）BOOSI劲步</p>
                                <h3>¥236.00</h3>
                        ...
                        <dd>
                            <a href="http://sc.chinaz.com/" class="pic"><img src="/home/img/like_02.png" alt="" /></a>
                            <div class="like-text">
                                <p>欧普</p>
                                <p>JYLZ08面板灯平板灯铝</p>
                                <h3>¥456.00</h3>
                ...
                <li class="yui3-u-1-6">
                    <dl class="picDl tuhua">
                        <dd>
                            <a href="http://sc.chinaz.com/" class="pic"><img src="/home/img/like_01.png" alt="" /></a>
                            <div class="like-text">
                                <p>三星（G5500）</p>
                                <p>移动联通双网通</p>
                                <h3>¥566.00</h3>
    ...
    <div class="py-container">
        ...
        <div class="clearfix yui3-g Interest">
            ...
            <div class="yui3-u row-405 Interest-conver">
                <img src="/home/img/interest01.png" />
            </div>
            <div class="yui3-u row-225 Interest-conver-split">
                <h5>好东西</h5>
                <img src="/home/img/interest02.png" />
                <img src="/home/img/interest03.png" />
            </div>
            <div class="yui3-u row-405 Interest-conver-split blockgary">
                <h5>品牌街</h5>
                <div class="split-bt">
                    <img src="/home/img/interest04.png" />
                </div>
                <div class="x-img fl">
                    <img src="/home/img/interest05.png" />
                </div>
                <div class="x-img fr">
                    <img src="/home/img/interest06.png" />
                </div>
            </div>
            <div class="yui3-u row-165 brandArea">
                <span class="brand-yline"></span>
                <ul class="yui3-g brand-list">
                    <li class="yui3-u-1-2 brand-pit"><img src="/home/img/brand01.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="/home/img/brand02.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="/home/img/brand03.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="/home/img/brand04.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="/home/img/brand05.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="/home/img/brand06.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="/home/img/brand07.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="/home/img/brand08.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="/home/img/brand09.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="/home/img/brand10.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="/home/img/brand11.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="/home/img/brand12.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="/home/img/brand13.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="/home/img/brand03.png" /></li>
                </ul>
            </div>
        </div>
            ...
            <div id="tab1" class="tab-pane active">
                <div class="yui3-g Floor-1">
                    <div class="yui3-u Left blockgary">
                        ...
                        <img src="/home/img/floor-1-1.png" />
                    </div>
                    <div class="yui3-u row-330 floorBanner">
                        <div id="floorCarousel" data-ride="carousel" data-interval="4000" class="sui-carousel slide">
                            ...
                            <div class="carousel-inner">
                                <div class="active item">
                                    <img src="/home/img/floor-1-b01.png">
                                </div>
                                <div class="item">
                                    <img src="/home/img/floor-1-b02.png">
                                </div>
                                <div class="item">
                                    <img src="/home/img/floor-1-b03.png">
                                </div>
                            </div>
                    ...
                    <div class="yui3-u row-220 split">
                        ...
                        <div class="floor-conver-pit">
                            <img src="/home/img/floor-1-2.png" />
                        </div>
                        <div class="floor-conver-pit">
                            <img src="/home/img/floor-1-3.png" />
                        </div>
                    </div>
                    <div class="yui3-u row-218 split">
                        <img src="/home/img/floor-1-4.png" />
                    </div>
                    <div class="yui3-u row-220 split">
                        <span class="floor-x-line"></span>
                        <div class="floor-conver-pit">
                            <img src="/home/img/floor-1-5.png" />
                        </div>
                        <div class="floor-conver-pit">
                            <img src="/home/img/floor-1-6.png" />
                        </div>
                    </div>
                </div>
            </div>
...
<div class="brand">
    <div class="py-container">
        <ul class="Brand-list blockgary">
            <li class="Brand-item">
                <img src="/home/img/brand_21.png" />
            </li>
            <li class="Brand-item"><img src="/home/img/brand_03.png" /></li>
            <li class="Brand-item"><img src="/home/img/brand_05.png" /></li>
            <li class="Brand-item"><img src="/home/img/brand_07.png" /></li>
            <li class="Brand-item"><img src="/home/img/brand_09.png" /></li>
            <li class="Brand-item"><img src="/home/img/brand_11.png" /></li>
            <li class="Brand-item"><img src="/home/img/brand_13.png" /></li>
            <li class="Brand-item"><img src="/home/img/brand_15.png" /></li>
            <li class="Brand-item"><img src="/home/img/brand_17.png" /></li>
            <li class="Brand-item"><img src="/home/img/brand_19.png" /></li>
        </ul>
    </div>
</div>
<!-- 楼层位置 -->
